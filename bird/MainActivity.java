...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonOpacity =(Button) findViewById(R.id.button4);
        Button buttonLengthy =(Button) findViewById(R.id.button5);
        ...
        buttonLengthy.setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View view){
                imageView.startAnimation(AnimationUtils.loadAnimation(MainActivity.this,R.anim.lengthy));
            }
        });
    }
}